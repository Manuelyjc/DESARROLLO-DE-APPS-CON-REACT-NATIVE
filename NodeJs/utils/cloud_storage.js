...
const storage = new Storage({
    projectId: "repositorio-apps-moviles-33aa7", // ID del proyecto COPIADO de Firebase
    keyFilename: './serviceAccountKey.json' //Archivo descargado de FireBase y renombrado
});

// RUTA COPIADA DE FIREBASE STORAGE, incluir el slash final
const bucket = storage.bucket("gs://repositorio-apps-moviles-33aa7.appspot.com/");
